...
shiny interface. As the API breaks support with previous versions, there is a
new package name, ``kurt2``.

Ideally you should rewrite your code to use the :doc:`new interface <kurt2>`.
