...
blockspec = Struct("blockspec",
    ...
    Whitespace(),
    OptionalGreedyRepeater(Rename("args", Struct("",
        value,
        Whitespace(),
    ))),
    Whitespace(),
    ...
    for category in categories:
        for block in category.blocks:
            ...
            block = (
                ...
                block.flag.value,
                block.command.value,
                [arg.value for arg in block.args],
            )
            blocks.append(block)
